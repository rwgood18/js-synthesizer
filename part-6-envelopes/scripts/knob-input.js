class KnobInput {
    constructor(containerElement, options) {
        ...
        this.visualElementClass = options.visualElementClass || 'knob-input_visual';
        ...
        this._input.classList.add('knob-input_input');
        this._visualElement = this._container.querySelector(`.${this.visualElementClass}`);
        this._visualElement.classList.add('knob-input_visual');
        // visual context
        this._visualContext = {
    ...
    startDrag(yPosition) {
        ...
        this._prevValue = parseFloat(this._input.value);
        this._input.focus();
        document.body.classList.add('knob-input_drag-active');
    ...
    clearDrag() {
        document.body.classList.remove('knob-input_drag-active');
    ...
    findActiveTouch(touchList) {
        ...
        for (i = 0, len = touchList.length; i < len; i++)
            if (this._activeDrag === touchList.item(i).identifier) return touchList.item(i);
        return null;
    }
